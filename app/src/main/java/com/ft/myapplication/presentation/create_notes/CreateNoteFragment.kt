package com.ft.myapplication.presentation.create_notes
...
class CreateNoteFragment :
    ...
    private val viewModel by activityViewModels<CreateNoteViewModel>()
    ...
    private fun initViews() = binding.apply {
        ...
        imgMore.setOnClickListener {
            val noteBottomSheetFragment =
                NoteBottomSheetFragment.newInstance(viewModel.noteId.value)
